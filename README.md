...
- 🏷️ **OWASP Classification** — Automatic categorization per OWASP Mobile Top 10
...
```
       ...
       ┌─────┬─────┴─────┬─────┐    ┌────┬────┴────┬────┐
       │     │           │     │    │    │         │    │
   Manifest Code   Certificate Native Net  Logcat  Data Frida
   Analysis Analysis Analysis Analysis     Collection    Hooks
                                 │
                    ┌────────────┴────────────┐
                    │   Correlation Engine    │
                    │  (Finding Correlator +  │
...
> 🛡️ *AndroidSecAnalyzer — Comprehensive Android Security Analysis Tool*
